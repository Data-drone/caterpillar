...
def test_match_all():
    ...
    # Simple match all
    r = MatchAllQuery([MockTestQuery([1, 2, 3], {'a': 1}), MockTestQuery([1, 3], {'b': 99})]).evaluate(None, None)
    ...
    r = MatchAllQuery([MockTestQuery([1, 2, 3]), MockTestQuery([1, 2, 3])],
                      [MockTestQuery([1]), MockTestQuery([2])]).evaluate(None, None)
...
def test_match_some():
    ...
    # Simple match some
    r = MatchSomeQuery([MockTestQuery([1, 3, 5], {'a': 1}), MockTestQuery([2, 4, 6], {'a': 1.5})]).evaluate(None, None)
